...
const techIcons = [
  ...
  { Icon: TbBrandNextjs, color: 'text-black dark:text-white', delay: 0.5 },
  ...
  { Icon: FaGithub, color: 'text-black dark:text-white', delay: 1.8 },
  { Icon: SiVercel, color: 'text-black dark:text-white', delay: 1.9 },
